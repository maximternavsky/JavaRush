...
public class Solution {
    ...
    public static void divide(double a, double b) {
        ...
        } else if (a == 0 & b == 0 | a == Double.NaN | b == Double.NaN | a == Double.POSITIVE_INFINITY & b == Double.POSITIVE_INFINITY | a == Double.POSITIVE_INFINITY & b == Double.NEGATIVE_INFINITY | a == Double.NEGATIVE_INFINITY & b == Double.POSITIVE_INFINITY | a == Double.NEGATIVE_INFINITY & b == Double.NEGATIVE_INFINITY) {
